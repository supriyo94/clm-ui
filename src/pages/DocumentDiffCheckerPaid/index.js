...
const DocumentDiffCheckerPaid = () => {
    ...
    const compareFiles = (e) => {
        ...
        axios({
            method: "get",
            url: `${API_HOST_URL}/convert-groupdocs?path1=${selectedSourceDocument[0].name}&path2=${selectedTargetDocument[0].name}`,
        }).then((response) => {
...
export default DocumentDiffCheckerPaid;